...
for (const item of ['src', 'manifests', 'scripts', 'tests', 'docs', '.claude', '.github', 'package.json', 'package-lock.json', 'amo-metadata.json', 'README.md', 'CLAUDE.md', 'LICENSE', '.gitignore', '.gitattributes', '.editorconfig']) collect(item);
